...
var openButton = header.querySelector('.mobile-menu__button');
var toggleMenu = document.querySelector('.mobile-wrapper');
var closeButton = menu.querySelector('.mobile-menu__button');
var mobileMenuButton = document.querySelectorAll('.mobile-menu__link');
...
mobileMenuButton.forEach(function (e) {
...
function init() {
  ...
  var placemark = new ymaps.Placemark([59.93863506417266, 30.323117499999945], {}, {
